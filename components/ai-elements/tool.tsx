...
const getStatusLabel = (
  ...
  switch (status) {
    case "approval-requested":
      return t("chat.tools.awaitingApproval");
    case "approval-responded":
      return t("chat.tools.responded");
    case "input-available":
      return t("chat.tools.running");
    case "input-streaming":
      return t("chat.tools.pending");
    case "output-available":
      return t("chat.tools.completed");
    case "output-denied":
      return t("chat.tools.denied");
    case "output-error":
      return t("chat.tools.error");
    default:
      return status;
  }
};
